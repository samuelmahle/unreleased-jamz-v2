              ...
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="text-gray-400 mb-4">
                    Submitted {format(new Date(suggestion.submittedAt), 'MMM d, yyyy')}
                  </p>
                    ...
                    <div>
                      ...
                      <dl className="space-y-1 text-sm">
                        ...
                        <div>
                          ...
                          <dd className="inline">
                            {suggestion.originalSong.releaseDate
                              ? format(new Date(suggestion.originalSong.releaseDate), 'MMM d, yyyy')
                              : 'Not set'}
                          </dd>
                        </div>
                      </dl>
                    ...
                    <div>
                      ...
                      <dl className="space-y-1 text-sm">
                        ...
                        <div>
                          <dt className="inline text-gray-400">Release Date: </dt>
                          <dd className="inline">
                            {suggestion.suggestedChanges.releaseDate
                              ? format(new Date(suggestion.suggestedChanges.releaseDate), 'MMM d, yyyy')
                              : 'Not set'}
                          </dd>
                        </div>
                      </dl>
